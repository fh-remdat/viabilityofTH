---
title: "REDD +"
author: "Freddie Hunter & Peter Tyrrell"
date: "07/12/2022"
output: html_document
---

# Calculating potential revenue from REDD+ in PAs across SSA

We want to calculate REDD+ potential returns until 2050 across SSA. To do this we will:

-   Create a database of PA working on Feber et al.,

-   Use the current forested extent and a 10% threshold of forest cover, to estimate potential losses in forest carbon across the period in PAs, and the potential avoided emissions by preventing that loss

-   We focus on forest loss because it generally has the highest returns, and is the focus on most REDD+ projects.

-   We will separately assess the potential for rangeland restoration and avoided depredation using a different method.
...
First we show the extent of the PAs we have collected, labelled for the presence of TH or not.
...
We used the Hansen Forest watch data.

First we have the forest cover layer for 2021.
...
We have an aggregated forest loss layer for the year 2010
...
We then mask out pixels with less than mean of 10% forest cover. 
...
# NOT SURE ON THIS AS THIS IS AGGREGATED PRESENCE ABSENCE DATA NOT COVER DATA>
...
#OR treat as a percgentage no a majority
